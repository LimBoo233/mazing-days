namespace Modules.Combat.Data.Enums
{
	...
	{
		AttackRoll, // 攻击检定 (我要扔 d20 vs 你的 AC)
		SavingThrow, // 豁免检定 (你扔 d20 vs 我的 DC)
		Guaranteed // 必中 (比如治疗术，或者 Magic Missile)
	}

	public enum StatAttributeSource
	{
		None, // 无修正
		Strength, // 强制使用力量
		Dexterity, // 强制使用敏捷
		...
		MainHandWeapon, // 跟随主手武器 (近战武器用Str，远程用Dex，灵巧武器取高)
		SpellCasting // 使用施法主属性 (自动判断是智力、感知还是魅力)
	}
}